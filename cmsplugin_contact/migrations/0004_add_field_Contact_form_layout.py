...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.form_layout'
        db.add_column(u'cmsplugin_contact', 'form_layout',
                      self.gf('django.db.models.fields.CharField')(default='cmsplugin_contact.forms.ContactForm', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.form_layout'
        db.delete_column(u'cmsplugin_contact', 'form_layout')
